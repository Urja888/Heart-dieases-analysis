...
def predict():
    ...
    predicated_price = heart_disease_detection(model, age, sex, cp, trestbps, chol, fbs, restecg, thalach, exang, oldpeak, slope, ca, thal)


    if predicated_price==1:
        return render_template("index.html", prediction_text="Heart disease detected")
    else:
        return render_template("index.html", prediction_text="Patient is safe. keep enjoying your life.")
